...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Adaptado : Prof. Ausberto S. Castro Vera, UENF, 2022
...
\usepackage[utf8]{inputenc}   %%% para usar o TECLADO em portugu\^{e}s
...
\hypersetup{
    ...
    % Package hyperref Warning: Option `bookmarks' has already been used, setting the option has no effect on input line 98.
    unicode=false,          % non-Latin characters in Acrobat’s bookmarks
    pdftoolbar=true,        % show Acrobat’s toolbar?
    pdfmenubar=true,        % show Acrobat’s menu?
    pdffitwindow=true,     % window fit to page when opened
    pdfstartview={FitH},    % fits the width of the page to the window
    pdftitle={Desenvolvimento Orientado a Objetos},    % title
...
%----------------------------------------------------------------------------------------
% Package hyperref Warning: Option `bookmarks' has already been used, setting the option has no effect on input line 586.

% ‪./Tex/01_Estrutura.tex, 586‬ Package hyperref Warning: Option `backref' has already been used, setting the option has no effect on input line 586.

% ‪./Tex/01_Estrutura.tex, 586‬ Package hyperref Warning: Option `pagebackref' has already been used, setting the option has no effect on input line 586.

% ‪./Tex/01_Estrutura.tex, 586‬ Package hyperref Warning: Option `hyperindex' has already been used, setting the option has no effect on input line 586.
...
\newenvironment{citadireta}{\begin{quoting}[rightmargin=0cm,leftmargin=4cm]
                            \footnotesize
                           }
                           {\end{quoting}
                           }
